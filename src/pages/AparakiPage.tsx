      ...
      <section className="relative min-h-[48vh] flex items-end pb-12 pt-24 bg-primary overflow-hidden">
        ...
        <div className="container-main relative z-10">
          ...
          <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}
            ...
            Home of the Alaparaki, one of the towns under the Orimolusi of Ijebu-Igbo.
          </motion.p>
        </div>
      </section>
        ...
        <div className="container-main">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            ...
            <h3 className="font-display font-black text-foreground text-lg leading-tight">
              His Royal Highness Oba Prof. Julius Adeniyi Benedict-Ogunfowora
            </h3>
            <p className="text-accent font-semibold text-sm mt-1">Rudewoluakannisuru I — The Alaparaki of Aparaki</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="section-padding bg-background">
        <div className="container-main max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, ease }}>
            ...
            <h3 className="heading-section mb-6">About Aparaki</h3>
          </motion.div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8 max-w-md">
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              ...
              <p className="font-bold text-foreground text-sm">Alaparaki</p>
            </motion.div>
          </div>

          <motion.p initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            transition={{ duration: 0.5, ease }} className="text-muted-foreground leading-relaxed mb-8">
            Aparaki is one of the towns under the traditional authority of the Orimolusi of Ijebu-Igbo. It was formerly led by an Olori-Ilu before being elevated to Obaship, now held by His Royal Highness Oba Prof. Julius Adeniyi Benedict-Ogunfowora, Rudewoluakannisuru I, the Alaparaki of Aparaki.
          </motion.p>
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            ...
            <p className="text-sm text-foreground/80 leading-relaxed">
              We're still gathering history, chiefs and heritage places for Aparaki. If you have content to share, reach out via the Contact page.
            </p>
          </motion.div>
        </div>
      </section>
